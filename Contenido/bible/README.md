...
|---|---|---:|---:|
| `PROYECTO-FIE 2026-2027 - Cicerchia César.pdf` | `PROYECTO-FIE 2026-2027 - Cicerchia Cesar.md` | 20 | 6405 |
| `Procesos y Agentes SEU - FIE con Backlog técnico (Jira).pdf` | `Procesos y Agentes.md` | 154 | 22305 |
...
Nota: `Procesos y Agentes SEU - FIE con Backlog tecnico Jira.pdf` queda como copia histórica local de 138 páginas; la fuente vigente para trabajo textual es la versión de 154 páginas listada arriba.
