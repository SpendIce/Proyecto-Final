...
\textbf{Cuerpo:} El Equipo de prueba invita a la Comunidad universitaria con revisión humana.
\end{tcolorbox}
\ficharevision{M001}
...
\textbf{Contacto:} pruebas@example.invalid\par\medskip
\textbf{Bajada:} Actividad de prueba de estructura.\par\medskip
\textbf{Cuerpo:} El Equipo de prueba invita al Público ficticio con revisión humana.
\end{tcolorbox}
\ficharevision{M004}
...
\textbf{Cuerpo:} El Área de prueba organiza un seminario remoto para la comunidad universitaria.
\end{tcolorbox}
\ficharevision{M007}
