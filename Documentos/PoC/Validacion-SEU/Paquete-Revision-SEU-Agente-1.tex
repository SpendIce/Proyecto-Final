...
\textbf{Borradores regenerados:} 2026-09-21 (versión vigente del sistema)
\end{titlepage}
...
Las nueve piezas se elaboraron a partir de tres actividades ficticias. Los datos permiten revisar si el texto conserva la información recibida. Las gacetillas corresponden a la corrida del 2026-09-21 con la versión vigente del sistema; los posts provienen del contrato de catálogo vigente.
...
\textbf{Bajada:} Actividad para probar el flujo.\par\medskip
\textbf{Cuerpo:} El Equipo de prueba invita a la Comunidad universitaria.
\end{tcolorbox}
\ficharevision{M001}
...
Una propuesta para aprender y compartir.\par\medskip
Sumate a una experiencia pensada para la comunidad.\par\medskip
\textbf{Título:} Taller sintético de vinculación\\
\textbf{Fecha:} 2026-08-05\\
\textbf{Organiza:} Equipo de prueba\\
\textbf{Lugar:} Aula de prueba\\
\textbf{Contacto:} pruebas@example.invalid\par\medskip
Encontrá el enlace en nuestro perfil.\par\medskip
\textbf{Hashtags:} \#FIE \#UNDEF
\end{tcolorbox}
\ficharevision{M002}
...
Una oportunidad para conectar conocimientos.\par\medskip
Te invitamos a ser parte de una experiencia de intercambio.\par\medskip
\textbf{Título:} Taller sintético de vinculación\\
\textbf{Fecha:} 2026-08-05\\
\textbf{Organiza:} Equipo de prueba\\
\textbf{Lugar:} Aula de prueba\\
\textbf{Contacto:} pruebas@example.invalid\par\medskip
Más información en el enlace de esta publicación.\par\medskip
\textbf{Hashtags:} \#FIE \#Ingenieria
\end{tcolorbox}
\ficharevision{M003}
...
\textbf{Contacto:} pruebas@example.invalid\par\medskip
\textbf{Bajada:} Actividad de prueba\par\medskip
...
Una propuesta para aprender y compartir.\par\medskip
Sumate a una experiencia pensada para la comunidad.\par\medskip
\textbf{Título:} Jornada sintética\\
\textbf{Fecha:} 2026-08-07\\
\textbf{Organiza:} Equipo de prueba\\
\textbf{Contacto:} pruebas@example.invalid\par\medskip
Encontrá el enlace en nuestro perfil.\par\medskip
...
\textbf{Bajada:} Actividad sintética para la comunidad universitaria.\par\medskip
\textbf{Cuerpo:} El Área de prueba organiza un seminario remoto.
\end{tcolorbox}
\ficharevision{M007}
...
Una propuesta para aprender y compartir.\par\medskip
Sumate a una experiencia pensada para la comunidad.\par\medskip
\textbf{Título:} Seminario sintético remoto\\
\textbf{Fecha:} 2026-08-09\\
\textbf{Organiza:} Área de prueba\\
\textbf{Contacto:} contacto@example.invalid\par\medskip
Encontrá el enlace en nuestro perfil.\par\medskip
