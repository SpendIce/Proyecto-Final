...
| P4 | HU-011 | Generación con LLM local bajo gate fail-closed | 3 | v2 0/6 `json_invalid`; v3 0/6 HTTP 400 grammar; v4 6/6 aceptadas, 7,035854–29,485820 s; regresión integral canónica del corte documental 2026-09-06: 513 verdes fuera del sandbox | Juan Ignacio Gone | Responsable técnico + Responsable RRSS / SEU | `CUMPLE_TECNICO`; SLA y calidad SEU pendientes |
...
El estado actual agrega HU-011 técnicamente conforme, Workspace E2E offline, tooling operativo, persistencia validada como spike y HU-012 offline. La regresión integral canónica del corte documental 2026-09-06 finalizó con 513 pruebas verdes fuera del sandbox. El **Gate G2 / TRL 3 permanece `PENDIENTE`** hasta ejecutar los incrementos live requeridos, registrar validación humana y obtener la decisión formal.
