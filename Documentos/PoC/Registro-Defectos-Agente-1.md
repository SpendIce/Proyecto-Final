...
| `DEF-A1-008` | 2026-08-18 | Commit `db06b3e`; evidencia v2/v3/v4 y corte de cobertura ampliada con 6/6 live y 4/4 negativos | Suite completa fuera del sandbox: 451 pruebas verdes, cero `EPERM`; cuatro output hashes reproducidos entre sesiones independientes | `RESUELTO_TECNICO`; no cerrado — falta validación SEU |
| `DEF-A1-009` | 2026-08-18 | Commit `db06b3e` con 70 archivos; README corregido en los puntos que dejaban de ser ciertos | 451 pruebas verdes fuera del sandbox; se retiraron las pruebas que afirmaban sobre prosa de README y `evidencias/` | Revisión técnica del incremento; no aceptación SEU |
