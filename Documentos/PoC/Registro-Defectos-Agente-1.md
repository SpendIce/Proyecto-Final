...
| `DEF-A1-008` | Conformidad generativa | HU-011 / Ollama | Local controlado | El smoke `aa4765e` obtuvo respuesta de transporte en 6/6 intentos y 0 timeouts, pero 0/6 salidas conformes; el gate rechazó todas y creó cero borradores. | `ALTA` | `ABIERTO` | Juan Ignacio Gone / responsable técnico IA | Experimento controlado con salida estructurada y render determinista —o hipótesis alternativa documentada— que produzca muestra conforme sin debilitar el gate; registrar aceptaciones y rechazos |
