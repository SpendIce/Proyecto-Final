...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{L{0.07\textwidth}L{0.24\textwidth}Y L{0.12\textwidth}}
    ...
    C0 & Alcance y plataforma m\'inima & Relevamiento P4, equipo validador \ac{SEU}, dependencias HU-001/HU-002, matriz de exclusiones y evidencia inicial & S1 \\
    ...
    CI & Integraci\'on y cierre & Contratos/mocks A2--A5, integraci\'on progresiva, pruebas \ac{SEU}, informe final, transferencia y gate \ac{TRL}~4 & S2 \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{lXl}
    ...
    H5 & HU-012 operativa con registro de env\'io y logs persistentes & Sep 2026 \\
    H6 & HU-013 operativa con email de inicio, invitaci\'on a chat y registro en Sheets & Oct 2026 \\
    H7 & HU-014 operativa con PDF, aprobaci\'on manual y log de emisi\'on & Nov 2026 \\
    H8 & Gate TRL~4: validaci\'on con usuarios reales SEU ($\geq$~3/4) & Dic 2026 \\
    H9 & Entrega de informe final del Proyecto & Dic 2026 \\
    \bottomrule
  \end{tabularx}
\end{table}
...
\begin{longtable}{L{0.11\textwidth}L{0.66\textwidth}L{0.17\textwidth}}
  ...
  \label{tab:planificacion-mensual}\\
    ...
    May 2026 & Ciclo HU-010: spike Sheets--Docs, primer prototipo de gacetilla, pruebas unitarias y validaci\'on temprana. Inicio paralelo de criterios HU-011 para Instagram y LinkedIn. & --- \\
    Jun 2026 & Ciclo HU-011: prototipo de posts por canal, refinamiento de prompts y validaci\'on \ac{SEU}. Consolidaci\'on de logs, checklist y evidencias de HU-010/HU-011. & H3: \ac{MVP} funcional \\
    Jul 2026 & Evaluaci\'on gate TRL~3. Auditor\'ia parcial de evidencias, defectos, checklist y tiempos de generaci\'on. Elaboraci\'on del informe de avance S1 y replanificaci\'on incremental de S2. & H4: Gate TRL~3 + Informe S1 \\
    \midrule
    \multicolumn{3}{l}{\textit{Semestre~2 --- Ago--Dic 2026}} \\
    \midrule
    Ago 2026 & Ciclo HU-012: confirmaciones autom\'aticas de inscripci\'on, registro de env\'io y logs persistentes. Inicio de contratos/mocks A2--A5 para desacoplar la integraci\'on. & --- \\
    Sep 2026 & Ciclo HU-013: interacci\'on interna iniciada por email con invitaci\'on a chat, registro operativo en Sheets y pruebas de usabilidad. Refinamiento del \ac{MVP} HU-010/HU-011 por feedback. & H5: HU-012 operativo \\
    Oct 2026 & Ciclo HU-014: plantilla de certificado, generaci\'on PDF, aprobaci\'on manual y log de emisi\'on. Integraci\'on progresiva A2--A5 en entorno de pruebas. & H6: HU-013 operativo \\
    Nov 2026 & Pruebas con usuarios reales de la \ac{SEU}: checklist de cuatro dimensiones, medici\'on de rechazo, trazabilidad, defectos cr\'iticos, seguridad y tiempo de generaci\'on. & H7: HU-014 operativo \\
    Dic 2026 & Evaluaci\'on gate TRL~4. Integraci\'on final con A2--A5. Elaboraci\'on y entrega del informe final del Proyecto. Cierre acad\'emico. & H8--H9: Gate TRL~4 + Informe Final \\
    \bottomrule
\end{longtable}
}
...
\begin{longtable}{L{0.22\textwidth}L{0.35\textwidth}L{0.35\textwidth}}
  ...
  \label{tab:factores-exito}\\
    ...
    FCE-3: Coordinaci\'on entre equipos y agentes & La integraci\'on del Agente~1 depende de acuerdos entre el equipo del Proyecto, la \ac{SEU}, infraestructura y los responsables de los dem\'as agentes. Si no existen contratos de interfaz e insumos m\'inimos de A2--A5, la comunicaci\'on integrada de S2 puede quedar reducida a operaci\'on aut\'onoma. & Reuniones peri\'odicas de sincronizaci\'on con equipos involucrados. Definir contratos de interfaz y mocks est\'aticos al inicio de S2 para desarrollar y probar la comunicaci\'on integrada aun cuando la disponibilidad real de otros agentes sea gradual. \\
    FCE-4: Trazabilidad operativa del agente & La entrega del Agente~1 requiere que cada pieza generada pueda asociarse con su solicitud, estado, salida producida, validador y resultado t\'ecnico. Sin esa trazabilidad, el sistema no puede operarse de forma controlada ni transferirse responsablemente a la \ac{SEU}. & Definir desde S1 un esquema de log con \texttt{id\_solicitud}, estado, validador, output y evidencia operativa. Integrar esos registros en el flujo normal del agente y verificarlos en cada gate de entrega. \\
    FCE-5: Despliegue progresivo y controlado & Saltar de documentaci\'on a operaci\'on real aumenta riesgo institucional y t\'ecnico. & Desplegar por etapas: documental, local controlado, sandbox Workspace, piloto \ac{SEU} limitado y release candidata \ac{TRL}~4. Cada etapa exige go/no-go y rollback definidos. \\
    \bottomrule
\end{longtable}
}
