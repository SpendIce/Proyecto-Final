...
\begin{table}[htbp]
  ...
  \begin{tabularx}{\textwidth}{lXlX}
    \toprule
    \textbf{Proceso} & \textbf{Uso del Agente~1} & \textbf{Rol A1} & \textbf{Responsable institucional} \\
    \midrule
    P4 -- Comunicaci\'on y Difusi\'on Institucional & Generaci\'on de gacetillas, posts, newsletters, mails y borradores de publicaciones. & Principal & Coordinador de Extensi\'on (A); Responsable de Gesti\'on del Conocimiento y Responsable de Redes Sociales (R) \\
    ...
    P5 -- Programas, Cursos y Diplomaturas & Confirmaciones, difusi\'on y certificados generados como borrador con validaci\'on previa. & Soporte comunicacional/documental & Coordinador de Extensi\'on (A); Responsable de cursos (R) \\
...
\begin{table}[H]
  ...
  \begin{tabularx}{\textwidth}{l l X X X l}
    \toprule
    \textbf{Elemento} & \textbf{Proceso} & \textbf{HU / requisito} & \textbf{DoD clave} & \textbf{Evidencia} & \textbf{Resp.} \\
    \midrule
    Gacetillas & P4 & HU-010 & Input desde Sheet; output en Google Docs; plantilla institucional aplicada; validaci\'on humana. & Documento generado, log, checklist de calidad. & COORD/RGC \\
    Posts RRSS & P4 & HU-011 & Formato adaptable a Instagram y LinkedIn; texto limpio y coherente; longitud configurable; validaci\'on humana. & Borrador de post, log, checklist canal. & RGC/RRSS \\
    Confirmaciones & P5/P4 & HU-012 & Trigger al registrar inscripci\'on; email generado autom\'aticamente; registro de env\'io. & Email recibido, log de env\'io. & Responsable de cursos \\
    Lenguaje natural interno & P4/P3 & HU-013 & Email de inicio con invitaci\'on a chat; respuesta usable; datos requeridos registrados en Sheets. & Captura de interacci\'on, registro en Sheet. & COORD/RGC \\
    Certificados & P5 & HU-014 & Plantilla base; PDF generado; validaci\'on previa obligatoria. & PDF generado, aprobaci\'on manual, log. & COORD/Administraci\'on \\
    Seguridad y auditor\'ia & Transversal & RNF seguridad / CONEAU & Inventario, credenciales seguras, \ac{RBAC}, logs, validaci\'on formal registrada. & Registro de activos, checklist seguridad, logs. & Go\~ne + SEU \\
    Exclusiones & P8/P9/soporte & HU-015, HU-025, HU-052, HU-060 fuera de alcance A1 & No implementar anal\'itica, scraping, atenci\'on p\'ublica ni soporte administrativo como parte de A1. & Revisi\'on de backlog y acta de alcance. & Cicerchia/SEU \\
    \bottomrule
  \end{tabularx}
\end{table}
