...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    \node[bloque, fill=blue!15] (a1) at (10.5, 0) {Agente~1\\(LangGraph + LLM)};
...
\begin{figure}[H]
  ...
  \begin{tikzpicture}[
    ...
    \node[font=\small\bfseries] at (0.9, 1.1) {LangGraph};
    \node[comp, minimum width=2.5cm, minimum height=0.7cm] at (4, 1.1) {Grafos de\\estado};
    \node[comp, minimum width=2.5cm, minimum height=0.7cm] at (7.5, 1.1) {Prompts y\\templates};
